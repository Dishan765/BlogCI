...
class PostController extends CI_Controller
{
  ...
  public function Edit($postid){
    ...
    if ($this->form_validation->run() == FALSE) {
      $record = $this->PostModel->edit($postid);
      $this->load->view('editPost', $record);
    } else {
      $data['category'] = $this->PostModel->updatePost($this->session->userdata('userID'));

      $this->session->set_flashdata('post_edit', 'Post edited sucessfully.');

...
<br />
<div>
  <form action="<?php echo base_url().'Userpost' ?>" method="POST">
    <fieldset>
      <div class="form-group col-md-6 mx-auto">
        <label for="InputTitle">Title</label>
        <div style="color:red;"><?php echo form_error('Title'); ?></div>
        <input type="text" class="form-control " id="InputTitle" name="Title" placeholder="Enter Title" value="<?php echo set_value($record['Title']); ?>">
      </div>
      ...
      <div class="form-group col-md-10 mx-auto">
        ...
        <textarea id="editor" class="form-control" id="myTextarea" name="Content">
          <?php echo set_value($record['Content']); ?>
        </textarea>
      </div>
